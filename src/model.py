...
class panoHDR(object):
    ...
    def test(self):
        ...
        for sample_file in sample_files:
            ...
            sample_image = [load_test_data_exr(sample_file, self.args.test_height, self.args.test_width)]
            ...
            image_paths = [os.path.join(self.args.out_dir, 'hdr_est', '{0}.exr'.format(os.path.basename(sample_file).split('.')[0])),]
            ...
            save_images_exr(fake_imgs[0], image_paths[0])
